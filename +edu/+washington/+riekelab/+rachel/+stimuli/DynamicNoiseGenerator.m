classdef DynamicNoiseGenerator < symphonyui.core.StimulusGenerator
    ...
    properties
        ...
        meanValues                % Mean amplitude over time
        stepDurations       %duration of time at each mean
    ...
    methods
        ...
        function obj = DynamicNoiseGenerator(map)
            if nargin < 1
                map = containers.Map();
            end
    ...
    methods (Access = protected)
        ...
        function s = generateStimulus(obj)
            ...
            noiseTime = obj.contrast * stream.randn(1, stimPts);
            ...
            stim(stim > obj.upperLimit) = obj.upperLimit;
            stim(stim < obj.lowerLimit) = obj.lowerLimit;
